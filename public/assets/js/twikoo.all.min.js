			...
			var e = {
						...
						var r,
							...
							f = {
								...
								doOnModalClick: function () {
									var e =
										f.modalStack[f.modalStack.length - 1];
									if (e) {
							...
							function E(e, n, r) {
								...
								if ("string" === a) {
									...
									if (d && e.constructor === ArrayBuffer)
										...
										!(
											Array.isArray(e) ||
											(d && ArrayBuffer.isView(e))
										)
									)
										throw new Error(t);
								}
								e.length > 64 &&
									(e = new x(n, !0).update(e).array());
								var f = [],
									p = [];
								for (o = 0; o < 64; ++o) {
									var h = e[o] || 0;
						...
						!(function () {
							if (
								...
								var e = [],
									...
									n = function () {};
								Prism.plugins.toolbar = {};
								var r = (Prism.plugins.toolbar.registerButton =
										function (n, r) {
											var i;
											((i =
												"function" == typeof r
									...
									i = (Prism.plugins.toolbar.hook = function (
										r,
									) {
					...
					1965: function (e, t, n) {
						...
						(e.exports && (e.exports = r),
							...
							(r.languages.markup.tag.inside[
								"attr-value"
							].inside.entity = r.languages.markup.entity),
							(r.languages.markup.doctype.inside[
								"internal-subset"
							...
							(r.languages.xml = r.languages.extend(
								"markup",
								{},
							)),
							...
							(r.languages.javascript = r.languages.extend(
								"clike",
								{
									"class-name": [
							...
							r.languages.markup &&
								(r.languages.markup.tag.addInlined(
									"script",
									"javascript",
								),
								...
								if (
									...
									r.fileHighlight = function () {
										(a ||
											...
											(a = !0)),
											r.plugins.fileHighlight.highlight.apply(
												this,
												arguments,
											));
									};
						...
						t.A = {
							...
							data: function () {
								return {
									...
									serverConfig: {},
									serverVersion:
										this.$twikoo.serverConfig.VERSION,
									...
									settings: [
										{
											...
											items: [
												...
												},
												{
													...
													desc: (0, a.t)(
														"ADMIN_CONFIG_ITEM_DISPLAYED_FIELDS",
													),
													ph: "".concat(
														(0, a.t)(
															"ADMIN_CONFIG_EXAMPLE",
										...
										},
										{
											...
											items: [
												...
												},
												{
													key: "IMAGE_CDN_URL",
													desc: (0, a.t)(
														"ADMIN_CONFIG_ITEM_IMAGE_CDN_URL",
													),
													ph: "".concat(
														(0, a.t)(
															"ADMIN_CONFIG_EXAMPLE",
												...
												},
												{
													key: "IMAGE_CDN_TOKEN",
													desc: (0, a.t)(
														"ADMIN_CONFIG_ITEM_IMAGE_CDN_TOKEN",
													),
													ph: "".concat(
														(0, a.t)(
															"ADMIN_CONFIG_EXAMPLE",
										...
										{
											name: (0, a.t)(
												"ADMIN_CONFIG_CATEGORY_PRIVACY",
											),
											items: [
												{
													key: "SHOW_UA",
													desc: (0, a.t)(
														"ADMIN_CONFIG_ITEM_SHOW_UA",
													),
													ph: "".concat(
														(0, a.t)(
															"ADMIN_CONFIG_EXAMPLE",
										...
										},
										{
											...
											items: [
												...
												},
												{
													key: "LIMIT_LENGTH",
													desc: (0, a.t)(
														"ADMIN_CONFIG_ITEM_LIMIT_LENGTH",
													),
													ph: "".concat(
														(0, a.t)(
															"ADMIN_CONFIG_EXAMPLE",
												...
												},
												{
													key: "BLOCKED_WORDS",
													desc: (0, a.t)(
														"ADMIN_CONFIG_ITEM_BLOCKED_WORDS",
													),
													ph: "".concat(
														(0, a.t)(
															"ADMIN_CONFIG_EXAMPLE",
										...
										{
											name: (0, a.t)(
												"ADMIN_CONFIG_CATEGORY_IM",
											),
											items: [
												{
													key: "PUSHOO_CHANNEL",
													desc: (0, a.t)(
														"ADMIN_CONFIG_ITEM_PUSHOO_CHANNEL",
													),
													ph: "".concat(
														(0, a.t)(
															"ADMIN_CONFIG_EXAMPLE",
												...
												},
												{
													key: "PUSHOO_TOKEN",
													desc: (0, a.t)(
														"ADMIN_CONFIG_ITEM_PUSHOO_TOKEN",
													),
													ph: "".concat(
														(0, a.t)(
															"ADMIN_CONFIG_EXAMPLE",
						...
						t.A = {
							data: function () {
								return {
									...
									warnText: {
										valine: (0, a.t)(
											"ADMIN_IMPORT_TIP_VALINE",
										),
										disqus: (0, a.t)(
											"ADMIN_IMPORT_TIP_DISQUS",
										),
										artalk: (0, a.t)(
											"ADMIN_IMPORT_TIP_ARTALK",
										),
										artalk2: "",
										twikoo: "",
									},
						...
						t.A = {
							...
							computed: {
								...
								iconBrowser: function () {
									return this.getIconBy(
										this.comment.browser,
										x,
									);
								},
							...
							methods: {
								...
								showContentExpandIfNeed: function () {
									this.hasContentExpand =
										this.hasContentExpand ||
										this.$refs["tk-content"].scrollHeight >
											500;
								},
								...
								popupLightbox: function (e) {
									if (
										"true" ===
										this.$twikoo.serverConfig.LIGHTBOX
									) {
										var t = e.target;
										if (
											"IMG" === t.tagName &&
						...
						t.A = {
							...
							methods: {
								...
								onCommentLoaded: function () {
									"function" ==
										typeof this.$twikoo.onCommentLoaded &&
						...
						t.A = {
							...
							methods: {
								...
								checkValid: function () {
									...
									return (
										(this.metaData.nick ||
											!this.requiredFields.nick) &&
										(e || !this.requiredFields.mail) &&
										(this.metaData.link ||
											!this.requiredFields.link)
									);
								},
								checkQQ: function () {
									if ((0, i.isQQ)(this.metaData.nick)) {
										var e = this.metaData.nick.replace(
												/@qq.com/gi,
												"",
											),
											t = "".concat(e, "@qq.com");
								...
								getQQNick: function (e) {
									var t = this,
										n =
											"https://api.qjqq.cn/api/qqinfo?qq=".concat(
												e,
											),
					...
					147: function (e, t, n) {
						...
						t.A = {
							...
							methods: {
								...
								initDraft: function () {
									var e =
										localStorage.getItem("twikoo-draft");
								...
								initTurnstile: function () {
									...
									this.config.TURNSTILE_SITE_KEY &&
										(window.turnstile
											? (this.turnstileLoad =
													Promise.resolve())
											: (this.turnstileLoad = new Promise(
													function (t, n) {
														var r =
															document.createElement(
																"script",
								...
								closeOwo: function () {
									this.owo &&
										this.owo.container.classList.contains(
											"OwO-open",
										) &&
										this.owo.toggle();
								},
									...
									if (
										...
										if (-1 !== h.indexOf(n.toLowerCase())) {
											var r = this.getUserId(),
												...
												o = t.join(".");
											this.paste(
												this.getImagePlaceholder(i, n),
											);
											var a = this.config.IMAGE_CDN;
											!this.$tcb || (a && "qcloud" !== a)
												? a
													? this.uploadPhotoToThirdParty(
															i,
															o,
															n,
															e,
								...
								return t(
									...
									[
										t(
											...
											{
												staticClass:
													"tk-admin-warn tk-admin-import-warn",
											},
											[
												t("p", [
													e._v(
					...
					6615: function (e, t, n) {
						...
						var Ee = [];
						function we(e) {
							(Ee.push(e), (xe.target = e));
						}
						function De() {
							(Ee.pop(), (xe.target = Ee[Ee.length - 1]));
						}
						...
						function Be(e) {
							return (ze(e, !0), Q(e, "__v_isShallow", !0), e);
						}
						function ze(e, t) {
							He(e) || Le(e, t, le());
						}
						...
						function wr(e, t) {
							if (!u(t)) return Er(t, e) ? 0 : -1;
							for (var n = 0, r = t.length; n < r; n++)
								if (Er(t[n], e)) return n;
							return -1;
						}
						var Dr = {
							enumerable: !0,
							...
							if (e["super"]) {
								...
								if (n !== e.superOptions) {
									...
									(r && L(e.extendOptions, r),
										(t = e.options = br(n, e.extendOptions))
											.name &&
						...
						function bi(e, t) {
							...
							for (n = 0; n < e.length; n++) {
								...
								r.def =
									r.def ||
									kr(t.$options, "directives", r.name);
							}
							return i;
						}
						function ki(e) {
						...
						function Ai(e, t) {
							...
							if (
								!(
									...
									l(r["class"]) &&
									(l(i) ||
										(l(i.staticClass) && l(i["class"])))
								)
							) {
								var o = (function (e) {
										for (
											var t = e.data, n = e, r = e;
											c(r.componentInstance);
										)
						...
						function Ni(e, t, n, r) {
							...
							Ii.addEventListener(
								e,
								t,
								se ? { capture: n, passive: r } : n,
							);
						}
						function Li(e, t, n, r) {
							(r || Ii).removeEventListener(
								e,
								t._wrapper || t,
								n,
							);
						...
						function Ki(e, t) {
							...
							if (
								...
								var i,
									...
									d = s || u,
									f = Hi(t.data.style) || {};
								t.data.normalizedStyle = c(f.__ob__)
									? L({}, f)
									: f;
								var p = (function (e, t) {
									for (
								...
								for (o in d) l(p[o]) && Wi(a, o, "");
								for (o in p)
									((i = p[o]), Wi(a, o, null == i ? "" : i));
							}
						}
						...
						var ro = A(function (e) {
								return {
									...
									enterActiveClass: "".concat(
										e,
										"-enter-active",
									),
									leaveClass: "".concat(e, "-leave"),
									leaveToClass: "".concat(e, "-leave-to"),
									leaveActiveClass: "".concat(
										e,
										"-leave-active",
									),
								};
								...
								if (
									...
									c(g)
										? ((e.elm = e.ns
											...
											h(n, e.elm, i))
										: d(e.isComment)
											? ((e.elm = o.createComment(
													e.text,
												)),
												h(n, e.elm, i))
											: ((e.elm = o.createTextNode(
													e.text,
												)),
												h(n, e.elm, i));
								}
							...
							function m(e, t, n) {
								if (u(t))
									...
									f(e.text) &&
										o.appendChild(
											e.elm,
											o.createTextNode(String(e.text)),
										);
							}
							function g(e) {
						...
						function Oo(e, t, n) {
							...
							if (!i || Array.isArray(r)) {
								for (
									var o, a, s = 0, u = e.options.length;
									s < u;
									s++
								)
									if (((a = e.options[s]), i))
						...
						var Go = function (e) {
							...
							Vo = L({ tag: String, moveClass: String }, Ro);
						delete Vo.mode;
						var Xo = {
							props: Vo,
							beforeMount: function () {
														...
														u = function () {
															if (
																...
																o.options
																	.extensions
																	.block &&
																o.options.extensions.block.some(
																	function (
																		n,
																	) {
																		return (
														...
														m = function () {
															...
															if (
																...
																s.options
																	.extensions
																	.inline &&
																s.options.extensions.inline.some(
																	function (
																		n,
																	) {
																		return (
							...
							return (
								(0, o["default"])(e, [
									...
									},
									{
										...
										value: function (e) {
											var t =
												this.rules.block.fences.exec(e);
											if (t) {
												var n = t[0],
													r = (function (e, t) {
														var n =
									...
									},
									{
										...
										value: function (e) {
											var t =
												this.rules.block.blockquote.exec(
													e,
												);
											if (t) {
												var n = t[0].replace(
									...
									},
									{
										...
										value: function (e) {
											var t =
												this.rules.block.table.exec(e);
											if (t) {
												var n = {
													type: "table",
													header: (0, u.splitCells)(
														t[1],
													).map(function (e) {
														return { text: e };
													}),
									...
									},
									{
										...
										value: function (e) {
											var t =
												this.rules.block.lheading.exec(
													e,
												);
											if (t) {
												var n = {
									...
									},
									{
										...
										value: function (e) {
											var t =
												this.rules.block.paragraph.exec(
													e,
												);
											if (t) {
												var n = {
									...
									},
									{
										...
										value: function (e, t) {
											...
											if (
												(n =
													this.rules.inline.reflink.exec(
														e,
													)) ||
												(n =
													this.rules.inline.nolink.exec(
														e,
													))
											) {
									...
									},
									{
										...
										value: function (e, t) {
											var n,
												r,
												i =
													this.rules.inline.autolink.exec(
														e,
													);
											if (i)
												return (
					...
					5779: function (e, t, n) {
						...
						((o._punctuation =
							...
							(o.emStrong.lDelim = (0, r.edit)(o.emStrong.lDelim)
								...
								.getRegex()),
							(o.emStrong.rDelimAst = (0, r.edit)(
								o.emStrong.rDelimAst,
								"g",
							)
								.replace(/punct/g, o._punctuation)
								.getRegex()),
							(o.emStrong.rDelimUnd = (0, r.edit)(
								o.emStrong.rDelimUnd,
								"g",
							)
								.replace(/punct/g, o._punctuation)
								.getRegex()),
						...
						t["default"] = (function () {
							function e(t) {
								...
								var r = {
									...
									target: document.getElementsByTagName(
										"textarea",
									)[0],
									position: "down",
									maxHeight: "250px",
								...
								(0, o["default"])(e, [
									{
										...
										value: function (e) {
											var t = this;
											((this.area = e.target),
												(this.packages = Object.keys(
													this.odata,
												)));
											for (
												var n =
														'<div class="OwO-logo">'.concat(
															e.logo,
															"</div>",
														) +
														'<div class="OwO-body">',
								...
								((n.onreadystatechange = function () {
									if (4 === n.readyState)
										if (
											...
											s.logger.warn(
												"OwO data request was unsuccessful: " +
													n.status,
											);
								}),
									n.open("get", e, !0),
						...
						t["default"] = function (e, t, i) {
							...
							((window.Prism = window.Prism || {}),
								...
								r ||
									((r = n(1965)),
									n(210),
									(r.plugins.autoloader.languages_path =
										"".concat(s, "/components/")),
									i &&
										(n(8072),
										i
					...
					7564: function (e, t, n) {
						...
						var i,
							...
							m = ["lskypro", "piclist", "easyimage"].map(
								function (e) {
									return '"'.concat(e, '"');
								},
							),
											...
											(0, o["default"])(
												(0, o["default"])(
													(0, o["default"])(
														...
														u + "_IMAGE_CDN_URL",
														[
															"图床的 URL，仅当 IMAGE_CDN 为 ".concat(
																m.join(" / "),
																" 时需要填写",
															),
															"圖床的 URL，僅當 IMAGE_CDN 為 ".concat(
																m.join(" / "),
																" 時需要填寫",
															),
															"圖床的 URL，僅當 IMAGE_CDN 為 ".concat(
